...
// from the parent directory; external deps come from the proxy.
replace github.com/ubiuser/caddy-geo-ops => ../

require (
	github.com/caddyserver/caddy/v2 v2.11.4
	github.com/stretchr/testify v1.11.1
	github.com/ubiuser/caddy-geo-ops v0.0.0
)
...
require (
	...
	github.com/maxmind/geoipupdate/v7 v7.1.1 // indirect
